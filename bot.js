...
client.on('message', message => {
    if(message.content.startsWith("!matchmake")){
       ...
       if(params.length < 3 || regions.indexOf(params[1].toLower()) < 0 || !params[2].startWith("steam://joinlobby/312530/")) {invalidSyntax(message); return;}
